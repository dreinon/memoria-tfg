...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.22\textwidth}p{0.10\textwidth}p{0.10\textwidth}p{0.29\textwidth}p{0.19\textwidth}}
    ...
    Derechos por imagen insuficientes & Media & Alto & Separar acceso, procesamiento y reproducción; autorización, atribución y proporcionalidad & Una comparación SMB y los 12 casos externos; corpus y paneles restantes no distribuidos \\
    \bottomrule
  \end{tabular}
\end{table}
...
fuente y se limita a la extensión justificada por ese propósito, conforme al artículo 32.1 de la
Ley de Propiedad Intelectual \cite{boeLpiArticle32}. No se presupone que la licencia del conjunto
...
como titularidad del estudiante sobre las obras, arreglos o ediciones.
