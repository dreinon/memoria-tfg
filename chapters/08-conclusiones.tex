...
ajuste fino no se oculta como objetivo incumplido: se estudió su viabilidad y se rechazó con una
regla compatible con la integridad del benchmark.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.31\textwidth}p{0.45\textwidth}p{0.14\textwidth}}
    ...
    Decidir sobre adaptación & Falta de datos independientes; \emph{NO-GO} documentado & Cumplido como decisión \\
