...
documentó 67 páginas no elegibles para análisis dependientes de sus anotaciones (66 por texto
incompleto y una por caja inválida), ocho de ellas incluidas en la comparación de imagen, y preservó una muestra
principal intacta dentro de su única partición oficial. La degradación final definió seis condiciones normalizadas por
escala de pentagrama y la ejecución reconcilió 1.152 resultados sobre 64 grupos documentales.
...
ejecutó después como estudio secundario sin reutilizar los 64 grupos documentales principales: el EDSR adaptado
mejoró al oficial en PSNR-Y y SSIM-Y en las seis condiciones sobre 20 grupos documentales retenidos, con intervalos
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.31\textwidth}p{0.45\textwidth}p{0.14\textwidth}}
    ...
    Auditar y gobernar SMB & 685 registros, 260 grupos documentales, elegibilidad, licencias y hashes & Cumplido \\
    ...
    Evaluar adaptación acotada & 45/13/20 grupos separados por identificador; dos puntos de control y 360 resultados & Cumplido con límites \\
...
por la separación entre líneas, se seleccionaron 64 grupos documentales sin solapamiento de identificadores y se repitió la
...
generador de degradación entre sus roles, aunque mantenga identificadores disjuntos, y x4 alcanzó su mejor
validación en el límite de 2.500 pasos. La unidad SMB identifica documentos, movimientos o secciones,
no necesariamente composiciones completas: hay movimientos de una misma sonata en entrenamiento
y prueba. Por ello, los resultados describen las fuentes retenidas, sin certificar generalización
a composiciones completas nunca vistas. Los intervalos dependen de esa agrupación y su precisión
puede verse afectada por parentesco residual; no se ha realizado sensibilidad por composición.
El piloto externo añade doce partes de banda, pero mantiene
...
completamente documentados. La publicación se limita por ello a comparaciones atribuidas e
integradas en el análisis: una página SMB y las doce páginas externas predeclaradas cuya
reproducción en el TFG fue autorizada por la SJMA. No se distribuyen ninguno de los dos corpus ni las salidas
restantes.
...
resultados y limitaciones, pero no redistribuyen los corpus completos ni las salidas restantes;
las reproducciones analíticas incluidas se identifican y atribuyen expresamente. EDSR se apoya en
