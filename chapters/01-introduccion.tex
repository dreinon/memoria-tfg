...
Estos objetivos se concretan en cinco preguntas de evaluación:
\begin{enumerate}
  ...
  \item ¿existen datos independientes y una carencia suficientemente definida para justificar un
        ajuste fino sin contaminar SMB?
\end{enumerate}
