...
La Figura~\ref{fig:score-anatomy} concreta el dominio sobre un fragmento real. Una partitura no es
solo una imagen de trazos negros: la distancia y continuidad de las cinco líneas, la forma de una
cabeza o una alteración y la separación entre símbolos codifican información. La
superresolución recibe una versión de baja resolución (LR) y estima una imagen de mayor resolución;
la referencia de alta resolución (HR) permite evaluar esa estimación. Por ello, enderezar un trazo
o aumentar el contraste puede mejorar la apariencia y, al mismo tiempo, unir elementos que debían
permanecer separados.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/context/score-anatomy.pdf}
  \caption[Elementos visuales de una partitura digitalizada]{Elementos visuales cuya geometría
  debe conservar la superresolución: clave, compás, dinámica, pentagramas, cabezas, plicas,
  ligaduras, alteraciones y acordes. Fragmento de \emph{Scott Joplin's New Rag}, de Scott Joplin,
  identificado en SMB como \texttt{joplin\_newrag}. Fuente: elaboración propia a partir de un
  recorte mínimo de SMB \cite{smbDatasetCard}.}
  \label{fig:score-anatomy}
\end{figure}
...
\begin{itemize}
  ...
  \item predeclarar degradaciones, comparadores, unidades de análisis, resultados y límites de
  ...
  \item evaluar una adaptación acotada con grupos documentales separados de la muestra confirmatoria y sin
...
\begin{enumerate}
  ...
  \item ¿qué defectos de pentagramas, símbolos, texto o textura aparecen en los casos cualitativos
        ...
        recuperación?;
  \item ¿qué compromiso existe entre fidelidad, tiempo de inferencia, licencias y riesgo de uso?;
  \item ¿mejora un ajuste fino acotado de EDSR la fidelidad sobre documentos SMB retenidos, manteniendo
...
del conjunto de datos, las unidades de análisis, el manifiesto, los operadores de degradación,
...
estudio secundario congeló antes de entrenar roles por identificador de grupo sin solapamiento y excluyó los 64 grupos documentales
...
idénticas para todos los comparadores y se agrupan por identificador documental en SMB y por obra en el piloto externo, mientras que las
...
El glosario inicial define los acrónimos y términos especializados utilizados en el documento.
...
y trabajo futuro. Los anexos conservan la información de reproducibilidad y, al final, la
