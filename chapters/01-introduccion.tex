...
\begin{itemize}
  ...
  \item evaluar una adaptación acotada con obras separadas de la muestra confirmatoria y sin
        consultar la prueba durante el entrenamiento; y
...
\begin{enumerate}
  ...
  \item ¿mejora un ajuste fino acotado de EDSR la fidelidad sobre obras SMB no vistas, manteniendo
        separadas las funciones de entrenamiento, validación y prueba?
\end{enumerate}
...
modelos preentrenados y un estudio secundario de adaptación dentro de SMB, con denominadores y
particiones distintos. Las conclusiones quedan restringidas a la población auditada, a los métodos
congelados y a las degradaciones controladas realmente evaluadas. No se asume que los resultados
sean válidos para escaneos reales no controlados, reconstrucción de PDF, reconocimiento óptico de
música, aplicaciones de usuario o despliegue.
...
de la comparación principal. Las páginas reciben entradas idénticas para todos los comparadores y
se agrupan por obra o fuente auditada, mientras que las regiones se tratan como observaciones
anidadas.
