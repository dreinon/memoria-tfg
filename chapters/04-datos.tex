...
618 tienen completos los textos regionales y son elegibles para análisis emparejados que dependan
...
el inventario a 260 grupos de fuente sin convertir las páginas de una misma fuente en
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.25\textwidth}p{0.14\textwidth}p{0.52\textwidth}}
    ...
    Textos regionales completos & 618 & Elegibles para análisis que dependan de la anotación textual \\
    Textos regionales incompletos & 67 & Se conservan; 66 por texto ausente y una por caja inválida \\
    ...
    Candidatas al recorrido v2 & 427 páginas / 207 obras & Tras excluir las 53 obras de v1 y las relaciones duplicadas o pendientes \\
    Rechazos de escala antes del cierre v2 & 76 de 140 examinadas & 75 procedían del grupo de 618 y una del grupo de 67 \\
    Muestra confirmatoria v2 & 64 páginas / 64 obras & 56 del grupo de 618 y ocho del de 67; todas con escala mensurable \\
    \bottomrule
  \end{tabular}
\end{table}
...
Figura~\ref{fig:sample-flow}. No partió exclusivamente de las 618 páginas con textos regionales
completos, ya que la reconstrucción de página completa no utiliza esos campos. Tras excluir las 53
obras del piloto v1 y las páginas con relaciones duplicadas o pendientes, quedaron 427 candidatas
de 207 obras. El recorrido determinista examinó 140 páginas hasta reunir 64 obras: el estimador
...
regional no usado por los modelos ni por las métricas. La selección de una página por obra mejora
la independencia y la comparabilidad, pero introduce un sesgo de mensurabilidad que debe acompañar
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[box] (all) {685 páginas procesadas en 260 obras\\
      618 con textos regionales completos y 67 sin completitud};
    \node[box, below=of all] (candidates) {427 páginas de 207 obras candidatas\\
      tras excluir obras v1 y relaciones duplicadas o pendientes};
    ...
    \node[box, below=of scale, fill=green!8] (sample) {64 páginas de 64 obras independientes\\
