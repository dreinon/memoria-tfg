...
principal. Esta utilizó 64 páginas de 64 obras independientes y seis degradaciones sintéticas:
...
Se definieron roles internos por obra con 45 grupos de entrenamiento, 13 de validación y 20 de
prueba, sin solapamiento ni reutilización de las 64 obras principales. El modelo adaptado superó al
EDSR oficial en PSNR-Y y SSIM-Y para las seis condiciones, con intervalos emparejados que no
cruzaron cero. Este resultado demuestra adaptación dentro de SMB y degradaciones coincidentes, no
transferencia a otras colecciones ni corrección musical.
